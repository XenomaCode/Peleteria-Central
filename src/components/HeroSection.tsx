    ...
    <section className="relative min-h-screen">
      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32 min-h-screen flex flex-col justify-center">
        <div className="max-w-xl md:max-w-2xl lg:max-w-3xl">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif text-white mb-4 md:mb-6 leading-tight">
            Adquiere los mejores materiales para <span className="text-amber-300">calzado</span>
          </h1>
          ...
          <Link href="/contacto">
            <button className="bg-amber-300 text-amber-900 font-bold py-2 sm:py-3 px-6 sm:px-8 rounded-md hover:bg-amber-400 transition-colors text-sm sm:text-base">
              CONTACTO
            </button>
          </Link>
        </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-20">
        <div className="relative">
          <div className="w-full h-12 sm:h-16 bg-white" style={{ clipPath: "polygon(0 100%, 100% 100%, 100% 0, 0 100%)" }}></div>
          <div className="absolute left-1/2 bottom-4 sm:bottom-8 transform -translate-x-1/2">
            <div className="bg-amber-900 rounded-full p-2 sm:p-3 animate-bounce shadow-lg">
